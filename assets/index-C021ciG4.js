(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const e=`modulepreload`,t=function(e){return`/front_7th_chapter2-1/`+e},n={},r=function(r,i,a){let o=Promise.resolve();if(i&&i.length>0){let r=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))},s=document.getElementsByTagName(`link`),c=document.querySelector(`meta[property=csp-nonce]`),l=c?.nonce||c?.getAttribute(`nonce`);o=r(i.map(r=>{if(r=t(r,a),r in n)return;n[r]=!0;let i=r.endsWith(`.css`),o=i?`[rel="stylesheet"]`:``,c=!!a;if(c)for(let e=s.length-1;e>=0;e--){let t=s[e];if(t.href===r&&(!i||t.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${r}"]${o}`))return;let u=document.createElement(`link`);if(u.rel=i?`stylesheet`:e,i||(u.as=`script`),u.crossOrigin=``,u.href=r,l&&u.setAttribute(`nonce`,l),document.head.appendChild(u),i)return new Promise((e,t)=>{u.addEventListener(`load`,e),u.addEventListener(`error`,()=>t(Error(`Unable to preload CSS for ${r}`)))})}))}function s(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return o.then(e=>{for(let t of e||[]){if(t.status!==`rejected`)continue;s(t.reason)}return r().catch(s)})};async function i(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(`/api/products?${s}`);if(!c.ok){let e=await c.json();throw Error(e.message)}return await c.json()}async function a(){let e=await fetch(`/api/categories`);return await e.json()}const o=({product:{productId:e,title:t,image:n,lprice:r,brand:i}})=>`
  ...
  `,s=async({params:e={}}={})=>{let t=document.getElementById(`product-list-container`);if(!t){console.error(`product-list-container not found`);return}try{let n=null,r=null,a=null;setTimeout(()=>{let t=document.getElementById(`products-grid`);infiniteScroll({callback:async()=>{n=await i(e),r=n.products,a=n.pagination.total,t.innerHTML+=`
            ${r.map(e=>o({product:e})).join(``)}
          `},targetElement:`#products-grid`})},0),t.innerHTML=`
      <!-- 상품 개수 정보 -->
      <div class="mb-4 text-sm text-gray-600">
        총 <span class="font-medium text-gray-900">${a}개</span>의 상품
      </div>
      <!-- 상품 그리드 -->
    ...
    `}},c=()=>{let e=e=>{s({params:{category1:e}})},t=e=>{s({params:{limit:parseInt(e)}})},n=e=>{s({params:{sort:e}})};return setTimeout(()=>{a().then(r=>{let i=document.getElementById(`category1-filter`),a=document.getElementById(`limit-select`),o=document.getElementById(`sort-select`);if(i)if(Object.keys(r).length===0)i.innerHTML=`<div class="text-sm text-gray-500 italic">카테고리가 없습니다.</div>`;else{let t=Object.keys(r).map(t=>`
            <button data-category1="${t}" onClick="${e(t)}"
                    class="category1-filter-btn text-left px-3 py-2 text-sm rounded-md border transition-colors
                           bg-white border-gray-300 text-gray-700 hover:bg-gray-50">
              ${t}
            </button>
          `).join(``);i.innerHTML=t,i.addEventListener(`click`,t=>{let n=t.target.closest(`.category1-filter-btn`);if(n){let t=n.dataset.category1;e(t)}})}a&&a.addEventListener(`change`,e=>{let n=e.target.value;t(n)}),o&&o.addEventListener(`change`,e=>{let t=e.target.value;n(t)})})},0),`
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
      ...
      <div class="space-y-3">
        ...
        <div class="space-y-2">
          ...
          <!-- 1depth 카테고리 -->
          <div id="category1-filter" class="flex flex-wrap gap-2">
  ...
  `),d=()=>`
    ${l({children:`
        ...
        ${u()}
      `})}
  `,f=`shopping_cart`,p=()=>{try{let e=localStorage.getItem(f);return e?JSON.parse(e):[]}catch(e){return console.error(`장바구니 조회 오류:`,e),[]}},m=e=>{try{let t=p(),n=t.findIndex(t=>t.productId===e.productId);return n>-1?t[n].quantity+=e.quantity||1:t.push({productId:e.productId,title:e.title,price:e.price,image:e.image,brand:e.brand||``,quantity:e.quantity||1}),localStorage.setItem(f,JSON.stringify(t)),{success:!0,cart:t,count:h()}}catch(e){return console.error(`장바구니 추가 오류:`,e),{success:!1,error:e.message}}},h=()=>{let e=p();return e.reduce((e,t)=>e+t.quantity,0)},g=()=>{let e=h(),t=document.getElementById(`cart-icon-btn`);if(!t)return;let n=t.querySelector(`span`);e>0?(n||(n=document.createElement(`span`),n.className=`absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center`,t.appendChild(n)),n.textContent=e,n.style.display=`flex`):n&&(n.style.display=`none`)},_=(e,t=`success`,n=3e3)=>{let r=document.querySelector(`.toast-notification`);r&&r.remove();let i={success:{bgColor:`bg-green-600`,icon:`
      ...
      `}},a=i[t]||i.success,o=document.createElement(`div`);if(o.className=`toast-notification fixed top-4 left-1/2 transform -translate-x-1/2 z-50 animate-slide-down`,o.innerHTML=`
  ...
  `,!document.querySelector(`#toast-styles`)){let e=document.createElement(`style`);e.id=`toast-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(o);let s=o.querySelector(`.toast-close-btn`);s.addEventListener(`click`,()=>{v(o)}),setTimeout(()=>{v(o)},n)},v=e=>{!e||!e.parentNode||(e.classList.remove(`animate-slide-down`),e.classList.add(`animate-slide-up`),setTimeout(()=>{e.parentNode&&e.remove()},300))},y=e=>{_(e,`success`)},b=e=>{_(e,`error`)},x=()=>{g(),document.addEventListener(`click`,e=>{let t=e.target;if(t.classList.contains(`add-to-cart-btn`)||t.closest(`.add-to-cart-btn`)){let e=t.classList.contains(`add-to-cart-btn`)?t:t.closest(`.add-to-cart-btn`);S(e)}})},S=e=>{try{let t=e.getAttribute(`data-product-id`),n=e.getAttribute(`data-product-title`),r=e.getAttribute(`data-product-price`),i=e.getAttribute(`data-product-image`),a=e.getAttribute(`data-product-brand`);if(!t||!n||!r){console.error(`상품 정보가 불완전합니다:`,{productId:t,title:n,price:r}),b(`상품 정보를 불러올 수 없습니다.`);return}let o=m({productId:t,title:n,price:parseInt(r),image:i,brand:a,quantity:1});o.success?(y(`장바구니에 추가되었습니다`),g()):b(`장바구니에 추가할 수 없습니다.`)}catch(e){console.error(`장바구니 추가 오류:`,e),b(`오류가 발생했습니다.`)}},C=()=>r(async()=>{let{worker:e}=await import(`./browser-BIdgEZIu.js`);return{worker:e}},[]).then(({worker:e})=>e.start({onUnhandledRequest:`bypass`,serviceWorker:{url:`/front_7th_chapter2-1/mockServiceWorker.js`,options:{scope:`/front_7th_chapter2-1/`}}}));function w(){let e=`
    <div class="min-h-screen bg-gray-50">
      <header class="bg-white shadow-sm sticky top-0 z-40">
        <div class="max-w-md mx-auto px-4 py-4">
          <div class="flex items-center justify-between">
  ...
  `,l=document.getElementById(`root`);l&&(l.innerHTML=d()),x()}C().then(w);