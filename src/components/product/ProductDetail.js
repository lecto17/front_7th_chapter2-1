...
export const ProductDetail = ({ product, relatedProductsHTML }) => {
  ...
  if (category1) {
    ...
    breadcrumb.push(`
      ...
      <a href="${category1Query}" data-link class="breadcrumb-link hover:text-blue-600 transition-colors">
        ${category1}
      </a>
    `);
  }
  if (category2) {
    ...
    breadcrumb.push(`ㄸ
      ...
      <a href="${category2Query}" data-link class="breadcrumb-link hover:text-blue-600 transition-colors">
        ${category2}
      </a>
    `);
  }
